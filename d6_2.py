...
print(data['col1'].value_counts().idxmin())
print(data['col2'].value_counts().idxmin())
print(data['col3'].value_counts().idxmin())
print(data['col4'].value_counts().idxmin())
print(data['col5'].value_counts().idxmin())
print(data['col6'].value_counts().idxmin())
print(data['col7'].value_counts().idxmin())
print(data['col8'].value_counts().idxmin())